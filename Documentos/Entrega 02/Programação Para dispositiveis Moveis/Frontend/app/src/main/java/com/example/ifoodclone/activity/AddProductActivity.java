...
public class AddProductActivity extends AppCompatActivity {
    ...
    private String[] categorias = {"Selecione a categoria", "Salgados", "Bebidas", "Marmitas", "Doces"}; // ⭐
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (produtoEditando != null) {
            preencherCampos(produtoEditando); // ⭐ agora preenche tudo
            btnConcluir.setText("Atualizar Produto");
            btnConcluir.setOnClickListener(v -> atualizarProduto(String.valueOf(produtoEditando.getId())));
        } else {
    ...
    private void preencherCampos(Product produto) {
        ...
        edtQuantidade.setText(String.valueOf(produto.getQuantity()));

        String categoria = produto.getCategory();
        if (categoria != null) {
    ...
    private void salvarProduto() {
        ...
        try {
            ...
            Toast.makeText(this, "Verifique os valores numéricos!", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        RequestBody categoryBody = RequestBody.create(MediaType.parse("text/plain"), categoria); // ⭐
        RequestBody quantityBody = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(quantidade)); // ⭐

        MultipartBody.Part imagePart = null;
        if (imageUri != null) {
            String filePath = com.example.ifoodclone.util.FileUtils.getPath(this, imageUri);
            if (filePath != null) {
        ...
        // ⭐ Agora envia categoria e quantidade também
        api.addProduto(bearer, nameBody, priceBody, descriptionBody, categoryBody, quantityBody, imagePart)
    ...
    private void atualizarProduto(String id) {
        ...
        try {
            ...
            Toast.makeText(this, "Verifique os valores!", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        api.updateProduto(bearer, id, nameBody, priceBody, descriptionBody, categoryBody, quantityBody, imagePart)
                .enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(AddProductActivity.this, "Erro ao atualizar produto", Toast.LENGTH_SHORT).show();
                        }
                    }
