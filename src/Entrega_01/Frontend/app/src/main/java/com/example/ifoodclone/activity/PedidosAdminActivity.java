...
public class PedidosAdminActivity extends AppCompatActivity {
    ...
    // >>> Ajuste AQUI para o nome real do seu layout dessa tela
    ...
    /** Interface Retrofit local (não precisa mexer no seu ApiService) */
    ...
    /** Marca um pedido como concluído (completed) */
